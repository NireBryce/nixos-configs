# Generated by Powerlevel10k configuration wizard on 2022-01-07 at 23:42 EST.
...
() {
  ...
  # User-defined:
  # ! Nire Note: This line was written in a tweet that romkatv the author of p10k corrected me on so it doesn't have as many footguns
  # ! That means: This line is theology, not engineering, because I do not remember how or why it got here, and do not plan to.
  # ! Consider it too spicy for prod. 
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='${${${EUID:#0}:+;: $(date +%T) ;}:-#}'

  # see https://twitter.com/romkatv/status/1536252817953923072
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='${${${EUID:#0}:+: $(date +%T) : ${PWD//\%/%%} ;}:-#}'
