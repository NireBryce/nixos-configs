...
Four for four. In each case the tool reported success.
...
**A summary line is not evidence.** `151 ok, 0 skipped` was true and useless — the
file it mishandled was counted as OK.
...
worse kind: the tool destroys the evidence and then reports its absence.
...
Consistently worth more than my analysis:
