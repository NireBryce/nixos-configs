# using https://github.com/EmergentMind/nix-config/blob/5f1852c3f5a18f7ed8c234b4fa1db0d34db0fad4/modules/hosts/common/yubikey.nix as a skeleton
{
    lib,
    pkgs,
    config,
...
let
    # todo: genericize by making better host config vars
    yubikey-up = 
      let
  ...
  yubikey-down = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      rm /home/elly/.ssh/id_yubikey
      rm /home/elly/.ssh/id_yubikey.pub
    '';
  };
in
{
    ...
    security.pam = lib.optionalAttrs pkgs.stdenv.isLinux {
      u2f = {
        ...
        settings = {
          ...
          authFile = "/home/elly/.config/Yubico/u2f_keys";
        };
      };
      services = {
        login.u2fAuth = true;
