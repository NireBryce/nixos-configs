<!--
Codifies the shape the `ship` skill's own PR-body guidance already asks
...
<!-- `just check` / `just modules` are enforced by CI on this PR -- this
section is for anything CI can't check: a real `just switch` on a host,
drvPath comparisons against unaffected hosts, a live check against a
running service, etc. -->

## Deliberately left alone

<!-- Anything that looked related but wasn't touched on purpose, and why. -->
