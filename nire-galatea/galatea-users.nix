{ pkgs, ... }:
{
  users.users.elly = {
      openssh.authorizedKeys.keys = [ ''ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKLrl5HoGmaeht/D6J/uZWyhpB04huXARmgoKJABuOw6 elly@nire-galatea'' 
                                      ''ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAII/CCC9LRJdjqLqq5t1a0wN1cbw2fmxs2Yxi1grl/nRw elly'' #@nire-sif # linux
                                      ''ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIDd9a8QFdEJljIv9k50cg+uejZGeEIRHhLXvaX8+e7g4 elly@nire-sif'' # windows
