...
in
{
  ...
  security.sudo.extraConfig = ''
    ...
    # With great power comes great responsibility.  Think before you type.
...
# Enable KDE
  ...
  users.users.elly = {
    ...
    openssh.authorizedKeys.keys = [ "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAID60nIDUkzCZmznLwfbHXoaxReXhuZUHiWzQh3LNRjqc elly" ];
