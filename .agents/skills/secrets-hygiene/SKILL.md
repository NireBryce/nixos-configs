...
Any command that touches `flake/modules/config-system/system/secrets/secrets.yaml`
...
- `flake/modules/config-system/system/secrets/sops.nix` — how secrets are declared
