...
`flake/modules/config-system/homelab/reverse-proxy/tailscale-services/`. That move is
...
- `flake/modules/config-system/homelab/reverse-proxy/tailscale-services/serve.nix` —
